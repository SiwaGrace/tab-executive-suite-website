    ...
    <section id="location" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start mb-12">
          <div>
            <h3 className="text-2xl font-bold text-gray-900 mb-6">Perfectly Located</h3>
            <p className="text-gray-700 mb-8 leading-relaxed">
              Enjoy easy access to key destinations in Accra. Our strategic location puts you close to shopping centers, hospitals, business districts, and the airport.
            </p>
          ...
          <div>
            <h3 className="text-2xl font-bold text-gray-900 mb-6">Find Us on Google Maps</h3>
            <div className="bg-gray-200 rounded-xl overflow-hidden shadow-lg h-96">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3970.8441234567!2d-0.2345678!3d5.5678901!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNcKwMzQnMDQuNCJOIDDCsDEzJzUyLjQiVw!5e0!3m2!1sen!2sgh!4v1234567890"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
