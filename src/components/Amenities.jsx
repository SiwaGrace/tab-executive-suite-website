...
const Amenities = () => {
  const buildingAmenities = [
    ...
    },
    {
      ...
      description: "Onsite security personnel",
    },
    {
      icon: Zap,
    ...
    },
    {
      ...
      description: "With reservoir backup",
    },
    {
      icon: Wifi,
      title: "High-Speed Internet",
      description: "Complimentary Wi-Fi access",
    },
    {
      icon: Tv,
      title: "Free DSTV",
    ...
    },
    {
      ...
      description: "Complimentary housekeeping",
    },
  ];
  ...
  const roomFeatures = [
    {
      ...
      description: "Climate control with fans",
    },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Enjoy world-class facilities designed to make your stay comfortable
            and convenient.
          </p>
        </div>
